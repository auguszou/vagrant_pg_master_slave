sed -i 's/^max_connections.*$/max_connections = 1024/g' ${PG_DATADIR}/postgresql.conf
sed -i 's/^hot_standby.*$/hot_standby = on/g' ${PG_DATADIR}/postgresql.conf
sed -i 's/^max_standby_streaming_delay.*$/max_standby_streaming_delay = 30s/g' ${PG_DATADIR}/postgresql.conf
sed -i 's/^wal_receiver_status_interval.*$/wal_receiver_status_interval = 1s/g' ${PG_DATADIR}/postgresql.conf
sed -i 's/^hot_standby_feedback.*$/hot_standby_feedback = on/g' ${PG_DATADIR}/postgresql.conf
